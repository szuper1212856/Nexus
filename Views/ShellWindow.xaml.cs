...
namespace NEXUS.Views
{
    public partial class ShellWindow : Window
    {
        ...
        public ShellWindow()
        {
            ...
            _vm.Search.PropertyChanged += OnSearchOpenChanged;
        ...
        /// <summary>Moves focus into the palette the moment it opens.</summary>
        private void OnSearchOpenChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName != nameof(SearchViewModel.IsOpen) || !_vm.Search.IsOpen) return;
        ...
        private void OnSearchKeyDown(object sender, KeyEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case Key.Enter:
                    _vm.Search.ChooseCommand.Execute(_vm.Search.Selected);
                    e.Handled = true;
                    break;

                case Key.Down:
                    _vm.Search.MoveSelection(1);
                    e.Handled = true;
                    break;
